...
<section class="section">
    ...
    <h1 class="section-heading">Post Güncelle</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-group col-12 col-md-6">
                ...
                {{Form::text('title',$post->title,['class'=>'form-control','placeholder'=>'Hollanda\'da 1 hafta'])}}
            </div>
            ...
            <div class="form-group  col-12 col-md-6">
                ...
                {{Form::number('trip_day',$post->trip_day,['class'=>'form-control','placeholder'=>'7 gün'])}}
            </div>
            ...
            <div class="form-group col-12">
                ...
                {{Form::textarea('body',$post->body,['id'=>'article-ckeditor','class'=>'','placeholder'=>'Yazmaya Başla..'])}}
            </div>
